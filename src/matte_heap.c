...
void matte_value_print(matteValue_t v) {
    ...
    switch(v.binID) {
      ...
      case MATTE_VALUE_TYPE_STRING: 
        ...
        printf("  Value:     %s\n", matte_bin_fetch(v.heap->sortedHeaps[MATTE_VALUE_TYPE_STRING], v.objectID) ? matte_string_get_c_str(matte_value_as_string(v)) : "null (WARNING: this string has been freed)");
        break;
      case MATTE_VALUE_TYPE_TYPE: 
      ...
      case MATTE_VALUE_TYPE_OBJECT: {
        ...
        printf("  Parents?   %s\n", matte_table_is_empty(m->refParents) ? "false" : "true");
        matte_heap_object_print_parents(v.heap, m->heapID);
        printf("  Children?  %s\n", matte_table_is_empty(m->refChildren) ? "false" : "true");
...
matteValue_t matte_heap_track_in(matteValue_t val, const char * file, int line) {
    ...
    if (!val.binID || val.binID == MATTE_VALUE_TYPE_TYPE) return val;
...
void matte_heap_track_neutral(matteValue_t val, const char * file, int line) {
    ...
    if (!val.binID || val.binID == MATTE_VALUE_TYPE_TYPE) return;
