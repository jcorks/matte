...
all:
	...
	@echo ""
	@echo "  src/MATTE_ROM "
	@echo "    > ROM including built-in modules. If youre using naked"
	@echo "      sources and dropping them in your project, include"
	@echo "      this with the sources!"
	@echo ""
	@echo "  matte "
	@echo "    > General-purpose interpreter"
	@echo ""
	@echo "  $(LIBRARY_NAME) "
	@echo "    > Static library including compiler and virtual machine"
	@echo ""
	@echo ""
	@echo "See /samples/embedding for embedding examples and"
	@echo "/samples/matte for Matte code samples to run in"
	@echo "the interpreter."
	@echo ""
	@echo "Have fun! Also post bugs to http://github.com/jcorks/matte"
	@echo " - JC"
	@echo "=========================================================="
	@echo ""
	@echo ""
...
debug:
	...
	@echo ""
	@echo "=========================================================="
	@echo "Done! The following were created with debugging symbols:"
	@echo ""
	@echo "  src/MATTE_ROM "
	@echo "    > ROM including built-in modules. If youre using naked"
	@echo "      sources and dropping them in your project, include"
